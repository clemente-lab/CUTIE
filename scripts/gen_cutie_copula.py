...
def gen_cutie_copula(working_dir):
    """
    ...
    seed(0)
    copula_table1_n50_lognorm_3_0_indep = copula(n1, indep_top, mu_mat, 
        lognorm_methods)
    seed(0)
    copula_table2_n50_gamma_1_0_100_indep  = copula(n1, indep_top, mu_mat, 
        gamma_methods)
    seed(0)
    copula_table1_n1000_lognorm_3_0_indep = copula(n2, indep_top, mu_mat, 
        lognorm_methods)
    seed(0)
    copula_table2_n1000_gamma_1_0_100_indep  = copula(n2, indep_top, mu_mat, 
        gamma_methods)
    ...
    copula_table2_n50_gamma_1_0_100 = copula(n1, dep_top, mu_mat, 
        gamma_methods)
    seed(0)
    copula_table1_n1000_lognorm_3_0 = copula(n2, dep_top, mu_mat, 
        lognorm_methods)
    seed(0)
    copula_table2_n1000_gamma_1_0_100 = copula(n2, dep_top, mu_mat, 
        gamma_methods)
    ...
    names = ['2copula_table1_n50_lognorm_3_0_indep.txt',
        '2copula_table2_n50_gamma_1_0_100_indep.txt', 
        '2copula_table1_n1000_lognorm_3_0_indep.txt', 
        '2copula_table2_n1000_gamma_1_0_100_indep.txt',
        '2copula_table1_n50_lognorm_3_0.txt',
        '2copula_table2_n50_gamma_1_0_100.txt', 
        '2copula_table1_n1000_lognorm_3_0.txt', 
        '2copula_table2_n1000_gamma_1_0_100.txt']
    ...
    for table, name in zip(tables,names):
        ...
        if name.split('_')[-1] == 'indep.txt':
            output.print_matrix(indep_top, working_dir + 'correlation_matrix_'+ 
                name, header = oids)
        else:    
        ...
        with open(working_dir + name,'rU') as f:
            samp_ids, bact_names, samp_bact, n_bact, n_samp = \
                parse.otu_parse(f, skip = 1, delimiter = '\t')
