...
def pointwise_comparison(samp_var1, samp_var2, pvalues, corrs, working_dir, 
    ...
    infln_metrics = ['cutie_1pc'] # ['cookd', 'dffits', 'cutie_1pc', 'dsr'] # 'dsr'
    infln_mapping = {
...
def updatek_cutie(initial_corr, pvalues, samp_var1, samp_var2, threshold, 
    ...
    cutiek_true_corr(initial_corr, samp_var1, samp_var2, pvalues, corrs, 
        threshold, paired, statistic, forward_stats, 
